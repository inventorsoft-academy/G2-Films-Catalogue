 ...
 */
@Component
public class FilmDataBase implements SaveDataToFile{
    ...
    private Comparator<Film> comparatorLikeDisLike = new Comparator<Film>() {
        @Override
        public int compare(Film o1, Film o2) {
            return o2.getDifferenceBetweenCountLikeAndDislike()-o1.getDifferenceBetweenCountLikeAndDislike();
        }
    };

    public List<String> getTop10Director(){
       List<String> directorList = films.stream()
    ...
    private int getAllDirectorsLike(String directorName){
       return films.stream()
                .filter(film->film.getDirector().equalsIgnoreCase(directorName))
                .map(Film::getDifferenceBetweenCountLikeAndDislike)
